...
// VertexPosColorUv1 index (override with '#define ImDrawIdx unsigned int' in imconfig.h)
#ifndef ImDrawIdx
typedef unsigned short ImDrawIdx;
#endif

// VertexPosColorUv1 layout
...
struct ImDrawList
{
    ...
    ImVector<ImDrawVert>    VtxBuffer;          // VertexPosColorUv1 buffer.
