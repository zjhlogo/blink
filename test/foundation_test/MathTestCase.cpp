...
{
    glm::mat4 matIdentity = NS::MAT4_IDENTITY;
    glm::mat4 matScale = glm::scale(NS::MAT4_IDENTITY, glm::vec3(4.0f, 5.0f, 6.0f));
    glm::mat4 matRotation = glm::eulerAngleXYZ(1.0f, 2.0f, 3.0f);
    glm::mat4 matTranslation = glm::translate(NS::MAT4_IDENTITY, glm::vec3(7.0f, 8.0f, 9.0f));
