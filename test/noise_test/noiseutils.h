...
namespace noise
{
    namespace utils
    {
        ...
        public:
            ...
            const GradientPoint* getGradientPointArray() const { return m_pGradientPoints; }
        ...
        public:
            ...
            /// calling it.
            const float* getConstSlabPtr(int row) const { return getConstSlabPtr(0, row); }
            ...
            /// This method does not perform bounds checking so be careful when
            /// calling it.
            const float* getConstSlabPtr(int x, int y) const { return m_pNoiseMap + (size_t)x + (size_t)m_stride * (size_t)y; }
            ...
            /// This method does not perform bounds checking so be careful when
            /// calling it.
            float* getSlabPtr(int x, int y) { return m_pNoiseMap + (size_t)x + (size_t)m_stride * (size_t)y; }
        ...
        private:
            ...
            size_t calcMinMemUsage(int width, int height) const { return calcStride((size_t)width) * (size_t)height; }
            ...
            /// - The stride amount is measured by the number of @a float values
            ///   between these two points, not by the number of bytes.
            size_t calcStride(int width) const { return (size_t)(((width + RASTER_STRIDE_BOUNDARY - 1) / RASTER_STRIDE_BOUNDARY) * RASTER_STRIDE_BOUNDARY); }
        ...
        public:
            ...
            /// This method does not perform bounds checking so be careful when
            /// calling it.
            const Color* getConstSlabPtr(int row) const { return getConstSlabPtr(0, row); }
            ...
            /// This method does not perform bounds checking so be careful when
            /// calling it.
            const Color* getConstSlabPtr(int x, int y) const { return m_pImage + (size_t)x + (size_t)m_stride * (size_t)y; }
            ...
            /// This method does not perform bounds checking so be careful when
            /// calling it.
            Color* getSlabPtr(int x, int y) { return m_pImage + (size_t)x + (size_t)m_stride * (size_t)y; }
            ...
            /// All positions outside of the image are assumed to have a common
            /// color value known as the <i>border value</i>.
            void setBorderValue(const Color& borderValue) { m_borderValue = borderValue; }
        ...
        public:
            ...
            void setDestFilename(const std::string& filename) { m_destFilename = filename; }
        ...
        public:
            ...
            /// the noise map.
            void setMetersPerPoint(float metersPerPoint) { m_metersPerPoint = metersPerPoint; }
            ...
            void setSourceNoiseMap(NoiseMap& sourceNoiseMap) { m_pSourceNoiseMap = &sourceNoiseMap; }
        ...
        public:
            ...
            void setDestNoiseMap(NoiseMap& destNoiseMap) { m_pDestNoiseMap = &destNoiseMap; }
            ...
            void setSourceModule(const module::ModuleBase& sourceModule) { m_pSourceModule = &sourceModule; }
        ...
        public:
            ...
            void setBackgroundImage(const Image& backgroundImage) { m_pBackgroundImage = &backgroundImage; }
            ...
            /// The destination image must exist throughout the lifetime of this
            /// object unless another image replaces that image.
            void setSourceNoiseMap(const NoiseMap& sourceNoiseMap) { m_pSourceNoiseMap = &sourceNoiseMap; }
